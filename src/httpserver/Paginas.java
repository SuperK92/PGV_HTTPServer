...
public class Paginas {
    ...
    public static final String fecha = "Date: " + HTTPServer.getDateValue();
    ...
    public static final String html_noEncontrado = "<html>"
        ...
        + "</body>"
        + "</html>";
    public static final String html_pagina1 = "<html>"
        + "<head><title>Página1</title></head>"
        + "<body>"
        + "<h1>Abriendo página 1</h1>"
        + "<p>Hola caracola!!</p>"
        + "</body>"
        + "</html>";
    public static final String html_pagina2 = "<html>"
        + "<head><title>Página2</title></head>"
        + "<body>"
        + "<h1>Abriendo página 2</h1>"
        + "<p>Hasta luego!!</p>"
        + "</body>"
        + "</html>";
}